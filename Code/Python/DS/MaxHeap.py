...
class MaxHeap:
    """Implementazione personalizzata di Max-Heap.
    ...
    ----------
    root : IndexedValue
        Elemento radice della Max-Heap (eq. getmax())
    ...
    def insert_val(self, x: int):
        """Inserimento valore nella Max-Heap
    ...
    def insert(self, x: IndexedValue):
        """Inserimento elemento nella Max-Heap
